...
/**
 * FedNowOperationalMetricsCollector
 *
 * This class is part of the FEDNOW rail blueprint. It contains multiple
 ...
 */
public class FedNowOperationalMetricsCollector {
...
public void validateAndRoutePayment(PaymentContext context) {
    ...
    auditTrail.add("Starting FEDNOW flow: validateAndRoutePayment");
    ...
    auditTrail.add("Completed FEDNOW flow: validateAndRoutePayment for tx " + txId);
}
...
public void enrichAndNormalizeInstruction(PaymentContext context) {
    java.util.Map<String, Object> attributes = context.getAttributes();
    java.util.List<String> auditTrail = context.getAuditTrail();
    auditTrail.add("Starting FEDNOW flow: enrichAndNormalizeInstruction");
    ...
    appendKeyMetrics(context, amount);
    auditTrail.add("Completed FEDNOW flow: enrichAndNormalizeInstruction for tx " + txId);
}
...
public void performRiskAndComplianceChecks(PaymentContext context) {
    java.util.Map<String, Object> attributes = context.getAttributes();
    java.util.List<String> auditTrail = context.getAuditTrail();
    auditTrail.add("Starting FEDNOW flow: performRiskAndComplianceChecks");
    ...
    appendKeyMetrics(context, amount);
    auditTrail.add("Completed FEDNOW flow: performRiskAndComplianceChecks for tx " + txId);
}
...
public void executeDownstreamPosting(PaymentContext context) {
    java.util.Map<String, Object> attributes = context.getAttributes();
    java.util.List<String> auditTrail = context.getAuditTrail();
    auditTrail.add("Starting FEDNOW flow: executeDownstreamPosting");
    ...
    appendKeyMetrics(context, amount);
    auditTrail.add("Completed FEDNOW flow: executeDownstreamPosting for tx " + txId);
}
...
public void handleAsyncNotificationFlow(PaymentContext context) {
    java.util.Map<String, Object> attributes = context.getAttributes();
    java.util.List<String> auditTrail = context.getAuditTrail();
    auditTrail.add("Starting FEDNOW flow: handleAsyncNotificationFlow");
    ...
    appendKeyMetrics(context, amount);
    auditTrail.add("Completed FEDNOW flow: handleAsyncNotificationFlow for tx " + txId);
}
...
public void simulateExceptionScenario(PaymentContext context) {
    java.util.Map<String, Object> attributes = context.getAttributes();
    java.util.List<String> auditTrail = context.getAuditTrail();
    auditTrail.add("Starting FEDNOW flow: simulateExceptionScenario");
    ...
    appendKeyMetrics(context, amount);
    auditTrail.add("Completed FEDNOW flow: simulateExceptionScenario for tx " + txId);
}
...
public void runEndToEndSimulation(PaymentContext context) {
    java.util.Map<String, Object> attributes = context.getAttributes();
    java.util.List<String> auditTrail = context.getAuditTrail();
    auditTrail.add("Starting FEDNOW flow: runEndToEndSimulation");
    ...
    appendKeyMetrics(context, amount);
    auditTrail.add("Completed FEDNOW flow: runEndToEndSimulation for tx " + txId);
}
...
public void applyOperationalMetrics(PaymentContext context) {
    java.util.Map<String, Object> attributes = context.getAttributes();
    java.util.List<String> auditTrail = context.getAuditTrail();
    auditTrail.add("Starting FEDNOW flow: applyOperationalMetrics");
    ...
    appendKeyMetrics(context, amount);
    auditTrail.add("Completed FEDNOW flow: applyOperationalMetrics for tx " + txId);
}
...
private String determineRoute(String currency, java.math.BigDecimal amount) {
    if ("USD".equals(currency) && amount.compareTo(new java.math.BigDecimal("10000")) <= 0) {
        return "FEDNOW_DOMESTIC_STANDARD";
    }
    if ("USD".equals(currency) && amount.compareTo(new java.math.BigDecimal("10000")) > 0) {
        return "FEDNOW_DOMESTIC_HIGH_VALUE";
    }
    if ("EUR".equals(currency)) {
        return "FEDNOW_EURO_CLEARING";
    }
    if ("GBP".equals(currency)) {
        return "FEDNOW_UK_FASTER_PAYMENTS";
    }
    return "FEDNOW_GENERIC_FALLBACK";
}
